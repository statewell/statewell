...
test("completion requires every passing check and required approval before evidence-based reopening", async () => {
  ...
  for (const acceptanceEvidence of [[], [complete.acceptanceEvidence[0]], [complete.acceptanceEvidence[0], complete.acceptanceEvidence[0]], [{ ...complete.acceptanceEvidence[0], status: "failed" }, complete.acceptanceEvidence[1]], [{ ...complete.acceptanceEvidence[0], status: "unverified" }, complete.acceptanceEvidence[1]], [{ ...complete.acceptanceEvidence[0], checkIndex: 2 }, complete.acceptanceEvidence[1]]]) {
